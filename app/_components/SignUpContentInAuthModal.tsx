...
const SignUpContentInAuthModal: React.FC<SignUpModalProps> = ({ isOpen, onClose, setScreen }) => {
...
//   const [screen, setScreen] = useState("signin")
  ...
  const signupMethod = async(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    ...
    >
      <div className="flex items-center justify-center min-h-screen ">
        <div className="absolute bg-black w-full max-w-xl p-4 rounded-3xl pb-16" onClick={(e) => e.stopPropagation()}>
          ...
          <button className="bg-white text-black px-4 py-2 rounded-xl w-full font-semibold hover:bg-gray-200 " onClick={(e) => signupMethod(e)}>
              <h1>Sign Up</h1>
          </button>
          ...
          <button type="button" className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-xl text-sm px-5 py-2.5 text-center items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2 flex justify-center w-full">
            ...
            <div>
              <div className="mt-6 text-gray-400"><div className="inline">Already have an account? </div>
              <div className="text-primary hover:underline ms-2 inline hover:cursor-pointer"
               onClick={(e) => 
               { e.stopPropagation(); setScreen("signin"); }
...
export default SignUpContentInAuthModal;
